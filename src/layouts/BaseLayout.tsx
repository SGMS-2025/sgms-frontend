...
const BaseLayoutContent: React.FC<BaseLayoutProps> = ({ SidebarComponent, HeaderComponent }) => {
...
export const BaseLayout: React.FC<BaseLayoutProps> = ({ SidebarComponent, HeaderComponent }) => {
  return (
    <SidebarProvider>
      <BaseLayoutContent SidebarComponent={SidebarComponent} HeaderComponent={HeaderComponent} />
    </SidebarProvider>
  );
};
