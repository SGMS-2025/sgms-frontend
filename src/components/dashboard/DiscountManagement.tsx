  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{t('discount.title')}</h1>
          <p className="text-gray-600 mt-1 text-sm sm:text-base">{t('discount.subtitle')}</p>
          {currentBranch && (
        ...
        <Button className="bg-orange-500 hover:bg-orange-600 w-full sm:w-auto" onClick={() => setShowCreateForm(true)}>
