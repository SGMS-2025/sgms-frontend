...
interface ClassQuickViewModalProps {
  classId: string;
  isOpen: boolean;
  onClose: () => void;
  onRefresh?: () => void;
...
/**
 * ============================================
 * ClassQuickViewModal Component
 * ============================================
 *
 * Displays class details in a modal dialog.
 * Shows:
 * - Basic info (name, status, trainer, schedule)
 * - Capacity with progress bar
 * - Enrolled students preview (first 5)
 * - Session schedule (upcoming sessions)
 * - Action buttons: Edit, Enroll, Close
 *
 * Features:
 * - Auto-refetch on open
 * - Loading skeleton
              ...
              <div className="px-6 pt-4 border-b">
                <TabsList>
                  ...
                  <TabsTrigger value="students" className="flex items-center gap-2">
                    ...
                    Students ({toNumber(classData.activeEnrollment)})
                  </TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="overview" className="flex-1 overflow-y-auto px-6 py-4 space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                  <div className="flex justify-between items-center mb-3">
                    <label className="text-sm font-semibold text-gray-700">Class Capacity</label>
                  ...
                  <p className="text-xs text-gray-600">
                    {toNumber(classData.capacity) - toNumber(classData.activeEnrollment)} slots available
                  </p>
                </div>
                    ...
                    {typeof classData.servicePackageId === 'object' && classData.servicePackageId.name && (
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <label className="text-sm font-semibold text-gray-700">Service Package</label>
                        </div>
                ...
                {classData.trainerIds && classData.trainerIds.length > 0 && (
                  <div className="bg-white border rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <label className="text-sm font-semibold text-gray-700">Trainers</label>
                    </div>
