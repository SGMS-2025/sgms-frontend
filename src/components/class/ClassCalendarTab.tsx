...
import { ClassInfoCard, ClassQuickViewModal } from './index';
 ...
 * ============================================
 *
 * Displays classes for a specific time slot in the schedule calendar.
 * Features:
 * - Filter by time slot and day of week (using TIME OVERLAP detection)
 * - View toggle: Card view / Table view
 * - Search classes
 * - Status filter
 * - Quick view modal (view only)
 *
 * Time Slot Logic:
 * - Shift time slot (05:00-10:00) is a virtual range from branch config
 * - Classes have specific times (08:00-10:00, 09:00-11:00, etc)
 * - Filter shows all classes that have ANY overlap with the shift time
 *
 * Example:
 * - Shift: 05:00 - 10:00
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-sm text-gray-500">
            ...
            {classesInSlot.length > 0 && ` • ${classesInSlot.length} class(es)`}
          </p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {!loading && !error && classesInSlot.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            <p>No classes scheduled for this time slot</p>
          </div>
        )}
            ...
            <table className="w-full text-sm">
              <thead className="border-b">
                <tr className="text-gray-600">
                  ...
                  <th className="text-left py-2 px-3">Trainers</th>
